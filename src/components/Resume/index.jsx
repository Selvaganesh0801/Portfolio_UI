          ...
          <div class="col-12">
            <div class="resume-wrapper">
              ...
              <div class="resume-block" data-aos="fade-up" data-aos-delay="100">
                <h2>My Education</h2>
                <p class="lead">A background in computer science and design that fuels my passion for front-end development.</p>

                <div class="timeline">
                  <div class="timeline-item" data-aos="fade-up" data-aos-delay="200">
                    <div class="timeline-left">
                      <h4 class="company">Greens Technologies</h4>
                      <span class="period">2023</span>
                    </div>
                    <div class="timeline-dot"></div>
<div class="timeline-right">
  <h3 class="position">Python Full Stack Development</h3>
  <p class="description">
    Trained in front-end and back-end technologies including HTML, CSS, JavaScript, Python, Django, and databases. Gained hands-on experience in building dynamic and responsive web applications.
                  ...
                  <div class="timeline-item" data-aos="fade-up" data-aos-delay="300">
                    <div class="timeline-left">
                      <h4 class="company">Bharathidasan University</h4>
                      <span class="period">2021 - 2023</span>
                    </div>
                    <div class="timeline-dot"></div>
<div class="timeline-right">
  <h3 class="position">Master of Computer Applications (MCA)</h3>
  <p class="description">
    Gained in-depth knowledge of software development, data structures, algorithms, and modern web technologies — building a strong foundation for real-world application development.
                  ...
                  <div class="timeline-item" data-aos="fade-up" data-aos-delay="400">
                   ...
                   <div class="timeline-dot"></div>
<div class="timeline-right">
  <h3 class="position">Bachelor of Computer Applications (BCA)</h3>
  <p class="description">
